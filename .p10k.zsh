# Generated by Powerlevel10k configuration wizard on 2020-06-01 at 22:51 CEST.
...
() {
  ...
  if [[ $POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_CHAR != ' ' ]]; then
    ...
    typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_FOREGROUND=#FF6AC1
  ...
  # Show battery in grey when it's fully charged.
